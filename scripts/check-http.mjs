...
const sitemap=await readFile('dist/sitemap.xml','utf8');const sitemapCount=(sitemap.match(/<loc>/g)||[]).length;assert.equal(sitemapCount,paths.filter(p=>!p.includes('/404/')).length);
